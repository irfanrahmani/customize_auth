<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
            ...
            @if ($user->phone_verified_at === null)
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-phone-verification"
                            class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
        ...
        <div>
            ...
            <!-- Display Current or Old Profile Picture -->
            <div class="mt-2">
                @php
                    $profileImage = old('profile')
                        ? asset('storage/' . old('profile'))
                        : ($user->profile
            ...
            <x-text-input id="profile" name="profile" type="file" class="mt-2 block w-full" accept="image/*" />
